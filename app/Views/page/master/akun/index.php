...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="form-group">
            <a href="<?= base_url('akun/edit') ?>" class="btn" style="background-color: white; width: 100%; border: 1px solid red; margin-bottom: 20px; color: red; font-weight: bold; margin-top: 20px;">
                Edit Profile
            </a>
            <a href="<?= base_url('login') ?>" class="btn btn-danger" style="background-color: red; width: 100%;">
                Logout
            </a>
        </div>
    </div>
